...
/*
  ...
  Authors: Glyn Hudson, Philipp Lopaur
  ...
  After placing the libraries in the Arduino "libraries" subfolder dont forget to restart the Arduino IDE.
  The library file names *.c and *.h should be the same as the library folder name.
  For example DHT.c DHT.h is placed in the DHT/ subfolder.
